...
const FlexContent = ({
  ifExists,
  endPoint: { title, subtitle, heading, text, img, url, btn },
}) => {
  return (
    <div
      className={`flex items-center justify-between gap-1 lg:flex-col lg:justify-center nike-container
