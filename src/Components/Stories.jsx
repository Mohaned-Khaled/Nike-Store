...
import { BsFillHeartFill, BsClockFill, BsHash } from "react-icons/bs";
      ...
      <div className="nike-container">
        ...
        <div className="mt-7">
          <Splide options={splideOptions}>
            {news.map((val, ind) => (
              <SplideSlide key={ind} className="mb-0.5">
                <div className="relative grid items-center gap-4 pb-2 rounded-lg shadow shadow-slate-200 ring-1 ring-slate-100">
                  ...
                  <div className="flex items-center justify-between w-full px-4">
                    <div className="flex items-center gap-0.5">
                      <BsFillHeartFill className="icon-style text-red-500 w-5 h-5" />
                      <span className="text-xs font-bold">{val.like}</span>
                    </div>
                    <div className="flex items-center gap-0.5">
                      <BsClockFill className="icon-style w-4 h-4 text-black" />
                      <span className="text-xs font-bold">{val.time}</span>
                    </div>
                    <div className="flex items-center gap-0.5">
                      <BsHash className="icon-style w-4 h-4 text-blue-600" />
